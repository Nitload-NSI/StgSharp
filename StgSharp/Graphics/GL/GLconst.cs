...
namespace StgSharp.Graphics
{
    ...
    using _glfw = _GLFWlibrary;

    public static unsafe partial class GLFW
    {
        internal static _glfw glfw = new _glfw();

        //these are consts defined in GLFW3.h
        ...
        //consts in internal.h

        internal const uint _GLFW_INSERT_FIRST = 0;
        internal const uint _GLFW_INSERT_LAST = 1;
        internal const uint _GLFW_POLL_PRESENCE = 0;
        internal const uint _GLFW_POLL_AXES = 1;
        ...
        internal const uint GL_CONTEXT_FLAGS = 0x821e;
        internal const uint GL_CONTEXT_FLAG_FORWARD_COMPATIBLE_BIT = 0x00000001;
        internal const uint GL_CONTEXT_FLAG_DEBUG_BIT = 0x00000002;
        internal const uint GL_CONTEXT_PROFILE_MASK = 0x9126;
        internal const uint GL_CONTEXT_COMPATIBILITY_PROFILE_BIT = 0x00000002;
        internal const uint GL_CONTEXT_CORE_PROFILE_BIT = 0x00000001;
        internal const uint GL_RESET_NOTIFICATION_STRATEGY_ARB = 0x8256;
        internal const uint GL_LOSE_CONTEXT_ON_RESET_ARB = 0x8252;
        internal const uint GL_NO_RESET_NOTIFICATION_ARB = 0x8261;
        internal const uint GL_CONTEXT_RELEASE_BEHAVIOR = 0x82fb;
        internal const uint GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH = 0x82fc;
        internal const uint GL_CONTEXT_FLAG_NO_ERROR_BIT_KHR = 0x00000008;
        internal const uint EGL_SUCCESS = 0x3000;
        internal const uint EGL_NOT_INITIALIZED = 0x3001;
        internal const uint EGL_BAD_ACCESS = 0x3002;
        internal const uint EGL_BAD_ALLOC = 0x3003;
        internal const uint EGL_BAD_ATTRIBUTE = 0x3004;
        internal const uint EGL_BAD_CONFIG = 0x3005;
        internal const uint EGL_BAD_CONTEXT = 0x3006;
        internal const uint EGL_BAD_CURRENT_SURFACE = 0x3007;
        internal const uint EGL_BAD_DISPLAY = 0x3008;
        internal const uint EGL_BAD_MATCH = 0x3009;
        internal const uint EGL_BAD_NATIVE_PIXMAP = 0x300a;
        internal const uint EGL_BAD_NATIVE_WINDOW = 0x300b;
        internal const uint EGL_BAD_PARAMETER = 0x300c;
        internal const uint EGL_BAD_SURFACE = 0x300d;
        internal const uint EGL_CONTEXT_LOST = 0x300e;
        internal const uint EGL_COLOR_BUFFER_TYPE = 0x303f;
        internal const uint EGL_RGB_BUFFER = 0x308e;
        internal const uint EGL_SURFACE_TYPE = 0x3033;
        internal const uint EGL_WINDOW_BIT = 0x0004;
        internal const uint EGL_RENDERABLE_TYPE = 0x3040;
        internal const uint EGL_OPENGL_ES_BIT = 0x0001;
        internal const uint EGL_OPENGL_ES2_BIT = 0x0004;
        internal const uint EGL_OPENGL_BIT = 0x0008;
        internal const uint EGL_ALPHA_SIZE = 0x3021;
        internal const uint EGL_BLUE_SIZE = 0x3022;
        internal const uint EGL_GREEN_SIZE = 0x3023;
        internal const uint EGL_RED_SIZE = 0x3024;
        internal const uint EGL_DEPTH_SIZE = 0x3025;
        internal const uint EGL_STENCIL_SIZE = 0x3026;
        internal const uint EGL_SAMPLES = 0x3031;
        internal const uint EGL_OPENGL_ES_API = 0x30a0;
        internal const uint EGL_OPENGL_API = 0x30a2;
        internal const uint EGL_NONE = 0x3038;
        internal const uint EGL_RENDER_BUFFER = 0x3086;
        internal const uint EGL_SINGLE_BUFFER = 0x3085;
        internal const uint EGL_EXTENSIONS = 0x3055;
        internal const uint EGL_CONTEXT_CLIENT_VERSION = 0x3098;
        internal const uint EGL_NATIVE_VISUAL_ID = 0x302e;
        //internal const uint EGL_NO_SURFACE = ((EGLSurface)0);
        internal static void* EGL_NO_SURFACE = ((void*)0);
        //internal const uint EGL_NO_DISPLAY = ((EGLDisplay)0);
        internal static void* EGL_NO_DISPLAY = ((void*)0);
        //internal const uint EGL_NO_CONTEXT = ((EGLContext)0);
        internal static void* EGL_NO_CONTEXT = ((void*)0);
        //internal const uint EGL_DEFAULT_DISPLAY = ((EGLNativeDisplayType)0);
        internal static void* EGL_DEFAULT_DISPLAY = ((void*)0);
        internal const uint EGL_CONTEXT_OPENGL_FORWARD_COMPATIBLE_BIT_KHR = 0x00000002;
        internal const uint EGL_CONTEXT_OPENGL_CORE_PROFILE_BIT_KHR = 0x00000001;
        internal const uint EGL_CONTEXT_OPENGL_COMPATIBILITY_PROFILE_BIT_KHR = 0x00000002;
        internal const uint EGL_CONTEXT_OPENGL_DEBUG_BIT_KHR = 0x00000001;
        internal const uint EGL_CONTEXT_OPENGL_RESET_NOTIFICATION_STRATEGY_KHR = 0x31bd;
        internal const uint EGL_NO_RESET_NOTIFICATION_KHR = 0x31be;
        internal const uint EGL_LOSE_CONTEXT_ON_RESET_KHR = 0x31bf;
        internal const uint EGL_CONTEXT_OPENGL_ROBUST_ACCESS_BIT_KHR = 0x00000004;
        internal const uint EGL_CONTEXT_MAJOR_VERSION_KHR = 0x3098;
        internal const uint EGL_CONTEXT_MINOR_VERSION_KHR = 0x30fb;
        internal const uint EGL_CONTEXT_OPENGL_PROFILE_MASK_KHR = 0x30fd;
        internal const uint EGL_CONTEXT_FLAGS_KHR = 0x30fc;
        internal const uint EGL_CONTEXT_OPENGL_NO_ERROR_KHR = 0x31b3;
        internal const uint EGL_GL_COLORSPACE_KHR = 0x309d;
        internal const uint EGL_GL_COLORSPACE_SRGB_KHR = 0x3089;
        internal const uint EGL_CONTEXT_RELEASE_BEHAVIOR_KHR = 0x2097;
        internal const uint EGL_CONTEXT_RELEASE_BEHAVIOR_NONE_KHR = 0;
        internal const uint EGL_CONTEXT_RELEASE_BEHAVIOR_FLUSH_KHR = 0x2098;
        internal const uint EGL_PLATFORM_X11_EXT = 0x31d5;
        internal const uint EGL_PLATFORM_WAYLAND_EXT = 0x31d8;
        internal const uint EGL_PRESENT_OPAQUE_EXT = 0x31df;
        internal const uint EGL_PLATFORM_ANGLE_ANGLE = 0x3202;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_ANGLE = 0x3203;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_OPENGL_ANGLE = 0x320d;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_OPENGLES_ANGLE = 0x320e;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_D3D9_ANGLE = 0x3207;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE = 0x3208;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_VULKAN_ANGLE = 0x3450;
        internal const uint EGL_PLATFORM_ANGLE_TYPE_METAL_ANGLE = 0x3489;
        internal const uint EGL_PLATFORM_ANGLE_NATIVE_PLATFORM_TYPE_ANGLE = 0x348f;
        internal static IntPtr eglGetConfigAttrib = glfw.egl.GetConfigAttrib;
        internal static IntPtr eglGetConfigs = glfw.egl.GetConfigs;
        internal static IntPtr eglGetDisplay = glfw.egl.GetDisplay;
        internal static IntPtr eglGetError = glfw.egl.GetError;
        internal static IntPtr eglInitialize = glfw.egl.Initialize;
        internal static IntPtr eglTerminate = glfw.egl.Terminate;
        internal static IntPtr eglBindAPI = glfw.egl.BindAPI;
        internal static IntPtr eglCreateContext = glfw.egl.CreateContext;
        internal static IntPtr eglDestroySurface = glfw.egl.DestroySurface;
        internal static IntPtr eglDestroyContext = glfw.egl.DestroyContext;
        internal static IntPtr eglCreateWindowSurface = glfw.egl.CreateWindowSurface;
        internal static IntPtr eglMakeCurrent = glfw.egl.MakeCurrent;
        internal static IntPtr eglSwapBuffers = glfw.egl.SwapBuffers;
        internal static IntPtr eglSwapInterval = glfw.egl.SwapInterval;
        internal static IntPtr eglQueryString = glfw.egl.QueryString;
        internal static IntPtr eglGetProcAddress = glfw.egl.GetProcAddress;
        internal static IntPtr eglGetPlatformDisplayEXT = glfw.egl.GetPlatformDisplayEXT;
        internal static IntPtr eglCreatePlatformWindowSurfaceEXT = glfw.egl.CreatePlatformWindowSurfaceEXT;
        internal const uint OSMESA_RGBA = 0x1908;
        internal const uint OSMESA_FORMAT = 0x22;
        internal const uint OSMESA_DEPTH_BITS = 0x30;
        internal const uint OSMESA_STENCIL_BITS = 0x31;
        internal const uint OSMESA_ACCUM_BITS = 0x32;
        internal const uint OSMESA_PROFILE = 0x33;
        internal const uint OSMESA_CORE_PROFILE = 0x34;
        internal const uint OSMESA_COMPAT_PROFILE = 0x35;
        internal const uint OSMESA_CONTEXT_MAJOR_VERSION = 0x36;
        internal const uint OSMESA_CONTEXT_MINOR_VERSION = 0x37;
        internal static IntPtr OSMesaCreateContextExt;
        internal static IntPtr OSMesaCreateContextAttribs;
        internal static IntPtr OSMesaDestroyContext;
        internal static IntPtr OSMesaMakeCurrent;
        internal static IntPtr OSMesaGetColorBuffer;
        internal static IntPtr OSMesaGetDepthBuffer;
        internal static IntPtr OSMesaGetProcAddress;
        internal const uint VK_NULL_HANDLE = 0;
        internal static IntPtr vkGetInstanceProcAddr;
