...
namespace StgSharp.HighPerformance.Memory
{
    public static class SlabAllocator
    {
        ...
        ///   concurrent access to allocated objects during expansion would cause memory
        ///   corruption</description></item><item><description>The  expansion lock mechanism is
        ///   essential even if allocation itself is single- threaded
        ///   </description></item></list></para> <para><strong> Chunked Layout: </strong><br />
        ///   Chunked layout allocators can optionally provide single-threaded versions since they
        ///   don't  require buffer expansion and copying. Each chunk is allocated independently,
        ///   avoiding the  memory relocation issues present in sequential  layouts. </para>
        /// </remarks>
