...
public struct AdaptiveBackoffStrategy
{
    ...
    public static AdaptiveBackoffStrategy Create()
    {
        return new AdaptiveBackoffStrategy
        {
            ...
            _localAttempts = 0,
            _fastRng =
            (uint)(Environment.TickCount64 ^ Thread.CurrentThread.ManagedThreadId * 0x9E3779B9U)
        };
    }
    ...
    /// </summary>
    public static (long attempts, long successes, double successRate) GetGlobalStats(
    ...
    private struct PerformanceStats
    {
        ...
        public readonly double SuccessRate => Attempts == 0 ? 0.0 : (double)Successes / Attempts;
