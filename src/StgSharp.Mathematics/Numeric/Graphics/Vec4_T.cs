...
namespace StgSharp.Mathematics.Numeric.Graphics
{
    ...
    public struct Vec4<T> : IUnmanagedVector<Vec4<T>> where T: unmanaged, INumber<T>
    {
        ...
        public static Vec4<T> Add(Vec4<T> left, Vec4<T> right)
        {
            return left + right;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly T Dot(Vec4<T> right)
        {
        ...
        public static Vec4<T> FromSpan(ReadOnlySpan<T> span)
        {
            if (span.Length < 4) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vec4<T> operator *(Vec4<T> vector, T scalar)
        {
            if (Unsafe.SizeOf<T>() == 4) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Vec4<T> operator *(T scalar, Vec4<T> vector)
        {
            return vector * scalar;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static T operator *(Vec4<T> left, Vec4<T> right)
        {
