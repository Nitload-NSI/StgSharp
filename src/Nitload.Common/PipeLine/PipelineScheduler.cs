...
namespace Nitload.Common.PipeLine
{
    /// <summary>
    ...
    public partial class PipelineScheduler : IConvertableToPipelineNode
    {
        ...
        public PipelineNode this[
                            PipelineNodeLabel label
        ] => _allNode[label];

        public bool IsRunning => runningStat.CurrentCount == 0;

        public IEnumerable<string> InputPortName => _beginning.InputPorts.Keys;

        public IEnumerable<string> OutputPortName => _beginning.OutputPorts.Keys;

        public PipelineNode BeginLayer => _beginning;

        public PipelineNode EndLayer => _ending;

        public PipelineNodeOperation Operation => (this as IConvertableToPipelineNode).NodeMain;

        /**/

        internal SemaphoreSlim RunningStat => runningStat;
        ...
        public void SetInput(
                    params (string label, IPipeLineConnectionPayload arg)[] parameters
        )
        {
        ...
        internal bool RequestNexConcurrentNode(
                      out PipelineNode node
        )
        {
            int index, level;
        ...
        internal bool RequestNextMainThreadNode(
                      out PipelineNode node
        )
        {
