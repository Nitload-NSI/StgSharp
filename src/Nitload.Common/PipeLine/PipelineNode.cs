...
#pragma warning disable CA1036
    ...
    #pragma warning restore CA1036
    {
        ...
        internal bool TryIncreaseLevelTo(
                      int level
        )
        {
            _count++;
        ...
        public PipelineNodeInPort GetInputPort(
                                  string lable
        )
        {
        ...
        public PipelineNodeOutPort GetOutputPort(
                                   string lable
        )
        {
        ...
        public PipelineNodeInPort? DefineCertainInputPort(
                                   string label
        )
        {
        ...
        public PipelineNodeOutPort? DefineCertainOutputPort(
                                    string label
        )
        {
