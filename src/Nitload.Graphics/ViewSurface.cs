...
namespace Nitload.Graphics
{
    public class ViewSurface
    {
        ...
        private static readonly ConcurrentDictionary<IntPtr, ViewSurface> _handleToViewPortIndex = [];
        private int _width, _height, _newWidth, _newHeight;

        internal unsafe ViewSurface()
        {
            _newHeight = 600;
            _newWidth = 800;
            FlushSize();
