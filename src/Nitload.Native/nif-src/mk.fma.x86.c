...
#include "nif_template.fma.x86.h"
...
NIF_MK_PROC_DECL_STD(float, sse, , fma)
{
        ...
        NIF_MAT_KERNEL_LOCAL *restrict ans_cur = ans + offset_2;
        ...
        for (size_t z = 0; z < count_0; z++) {
                NIF_MAT_KERNEL_LOCAL const *right_base = right;
                NIF_MAT_KERNEL_LOCAL const *left_base = left;
...
NIF_MK_PROC_DECL_STD(float, avx, , fma)
{
        ...
        for (size_t z = 0; z < count_0; z++) {
                NIF_MAT_KERNEL_LOCAL const *b_base = right;
                NIF_MAT_KERNEL_LOCAL const *a_base = left;
                ...
                NIF_MK_FMA_F32_AVX2_CYCLE(0);
                NIF_MK_FMA_F32_AVX2_CYCLE(1);
                NIF_MK_FMA_F32_AVX2_CYCLE(2);
                NIF_MK_FMA_F32_AVX2_CYCLE(3);
        }
...
NIF_MK_PROC_DECL_STD(float, avx, _fma, fma)
{
        ...
        for (size_t z = 0; z < count_0; z += 2) {
                const NIF_MAT_KERNEL_LOCAL *a_base = left + z;
                const NIF_MAT_KERNEL_LOCAL *b_base = right + z;
...
NIF_MK_PROC_DECL_STD(float, 512, , fma)
{
        ...
        for (size_t z = 0; z < count_0; z += 4) {
                ...
                NIF_MK_FMA_F32_512_CYCLE(0);
                NIF_MK_FMA_F32_512_CYCLE(1);
                NIF_MK_FMA_F32_512_CYCLE(2);
                NIF_MK_FMA_F32_512_CYCLE(3);
        }
...
NIF_MK_PROC_DECL_STD(double, sse, , fma)
{
        ...
        for (size_t z = 0; z < count_0; z++) {
                ...
                NIF_MK_FMA_F64_SSE_PHASE(0);

                NIF_MK_FMA_F64_SSE_PHASE(1);

                NIF_MK_FMA_F64_SSE_PHASE(2);

                NIF_MK_FMA_F64_SSE_PHASE(3);
        }
...
NIF_MK_PROC_DECL_STD(double, 512, , fma)
{
        ...
        for (size_t z = 0; z < count_0; z += 2) {
                NIF_MAT_KERNEL_LOCAL const *right_base = right + z;
                NIF_MAT_KERNEL_LOCAL const *left_base = left + z;
                ...
                NIF_MK_FMA_F64_AVX2_CYCLE(0);
                NIF_MK_FMA_F64_AVX2_CYCLE(1);
                NIF_MK_FMA_F64_AVX2_CYCLE(2);
                NIF_MK_FMA_F64_AVX2_CYCLE(3);
        }
