...
#define NIF_MK_FMA_F32_512_CYCLE(i)                                                       \
        do {                                                                             \
...
#define NIF_MK_FMA_F32_AVX2_CYCLE(i)                                                       \
        do {                                                                             \
...
#define NIF_MK_FMA_F64_AVX2_CYCLE(i)                                                       \
        do {                                                                             \
...
#define NIF_FMA_F32_512_PACK_COLUMN(col, target)                                   \
        do {                                                              \
...
#define NIF_FMA_F32_AVX2_PACK_COLUMN(col, target)                                   \
        do {                                                              \
...
#define NIF_FMA_F64_512_PACK_COLUMN(col, target)                                   \
        do {                                                              \
                register __m128 high128 = _mm256_extractf32x4_ps(col, 1); \
                register __m128 low128 = _mm256_castps256_ps128(col);    \
                register __m128 half128 = _mm_add_ps(high128, low128);    \
...
// double
#define NIF_MK_FMA_F64_SSE_PHASE(i)                                               \
        do {                                                                     \
                /* k = 0 */                                                      \
