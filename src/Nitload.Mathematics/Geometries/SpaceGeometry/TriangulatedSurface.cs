...
namespace Nitload.Geometries
{
    public class TriangulatedSurface
    {
        ...
        private List<Vec3<float>> _vertices;
        ...
        /**/
        public IEnumerable<List<int>> SideIndicesEnumerable => _sideIndices;
        ...
        public Span<Vec3<float>> VertexSpan => CollectionsMarshal.AsSpan(_vertices);

        public Span<int> TriangleIndicesSpan => CollectionsMarshal.AsSpan(_triangleIndices);

        /**/
        public void AddIndicesByOrder(
                    int v1,
                    int v2,
                    int v3
        )
