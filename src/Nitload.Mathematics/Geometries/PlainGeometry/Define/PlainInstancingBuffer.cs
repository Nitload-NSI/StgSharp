...
namespace Nitload.Geometries
{
        ...
        where T : IInstancing
    {
        ...
        private List<Vec4<float>> coordList;
        ...
        public List<Vec4<float>> CoordAndRotationList => coordList;

        public List<float> ScalingList => scalingList;

        public Span<Vec4<float>> CoordAndRotationSpan => CollectionsMarshal.AsSpan(coordList);
