// -----------------------------------------------------------------------------
// file="PanelStateIncrementalGenerator.Models"
// Project: StgSharp
// Copyright (c) Nitload.
...
namespace Nitload.UserInterface.Generator
{
    internal static class PanelStateIncrementalGeneratorKnownAttributes
    {

        public const string PanelStateNodeAttribute = "Nitload.UserInterface.PanelStateNodeAttribute";

        public const string StateChangeBindingAttribute = "Nitload.UserInterface.StateChangeBindingAttribute";

        public static bool IsKnown(
                           string? metadataName
        )
        {
            return IsStateSymbolAttribute(metadataName) ||
                   metadataName == StateChangeBindingAttribute;
        }
