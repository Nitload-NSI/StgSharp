...
SSCAPI int SSCDECL gladLoadGLContextUserPtr(GladGLContext* context, GLADuserptrloadfunc load, void* userptr)
{
    int version;
...
SSCAPI int SSCDECL gladLoadGLContext(GladGLContext* context, GLADloadfunc load) {
...
SSCAPI int SSCDECL gladLoaderLoadGLContext(GladGLContext* context)
{
    int version = 0;
    void* handle;
    int did_load = 0;
...
SSCAPI void SSCDECL gladLoaderUnloadGLContext(GladGLContext* context) {
    if (context->glad_loader_handle != NULL) {
