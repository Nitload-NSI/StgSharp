...
#define GLAD_GL_IS_SOME_NEW_VERSION 0
    ...
    static int glad_gl_get_extensions(GladGLSC2Context* context, int version, const char** out_exts, unsigned int* out_num_exts_i, char*** out_exts_i) {
...
static int glad_gl_find_extensions_glsc2(GladGLSC2Context* context, int version) {
    ...
    context->IMG_pvric_end_to_end_signature = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_IMG_pvric_end_to_end_signature");
    context->IMG_tile_region_protection = glad_gl_has_extension(version, exts, num_exts_i, exts_i, "GL_IMG_tile_region_protection");
