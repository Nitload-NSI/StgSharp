...
INTERNAL void _cdecl transpose32(__3_columnset *source,
                                        __2_columnset *target)
{
        __m128 t0 = _mm_shuffle_ps(ALIGN(source->column[0]),
                                   ALIGN(source->column[1]),
                                   _MM_SHUFFLE(1, 0, 1, 0));
        __m128 t2 = _mm_shuffle_ps(ALIGN(source->column[2]), zeroVec,
                                   _MM_SHUFFLE(1, 0, 1, 0));
...
INTERNAL void _cdecl transpose33(__3_columnset *source,
                                        __3_columnset *target)
{
        ...
        __m128 t2 = _mm_shuffle_ps(ALIGN(source->column[2]), zeroVec,
                                   _MM_SHUFFLE(1, 0, 1, 0));
        __m128 t3 = _mm_shuffle_ps(ALIGN(source->column[2]), zeroVec,
                                   _MM_SHUFFLE(3, 2, 3, 2));
...
INTERNAL void _cdecl transpose34(__3_columnset *source,
...
INTERNAL float _cdecl det_mat3_internal(__m128 const c0,
                                                __m128 const c1,
                                                __m128 const c2)
{
...
INTERNAL float _cdecl det_mat3(__3_columnset *source,
                                     __3_columnset *transpose)
{
        return det_mat3_internal(source->column[0], source->column[1],
                                 source->column[2]);
}
