/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.36 on Fri May  5 16:55:33 2023.
...
#include <stdint.h>
    ...
    typedef void(*ReportApiAddress)(uint64_t apiAdd);

    __declspec(dllexport) ReportApiAddress report;
