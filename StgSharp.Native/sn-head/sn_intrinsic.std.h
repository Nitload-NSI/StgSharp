...
#define SN_MK_PROC_DECL_STD(T_type, T_arch, T_feature, T_op)                          \
        INTERNAL NOINLINE SN_STD_TARGET_ATTR(T_arch, T_feature) void SN_DECL \
                MK_PROC_NAME_STD(T_type, T_arch, T_feature, T_op)(MAT_TASK(T_type) const *task)
...
#define SN_SK_PROC_DECL_STD(T_type, T_arch, T_feature, T_op)                                 \
        INTERNAL NOINLINE SN_STD_TARGET_ATTR(T_arch, T_feature) void SN_DECL \
                SK_PROC_NAME_STD(T_type, T_arch, T_feature, T_op)( \
